...
<body>
    ...
    <main>
        <section class="container mt-5">
            <div class="card">
                <div class="card">
                    <div class="card-header text-center">Passbook Generator</div>
                    <div class="card-body bg-secondary-subtle p-4">
                        <form action="" method="POST">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-auto">
                                    <label for="inputPassword6" class="col-form-label">Gurdain Name</label>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-group mb-3">
                                        <select class="form-select" id="inputGroupSelect01">
                                            <option selected>Relation</option>
                                            <option value="S/O">Mother(Son)</option>
                                            <option value="D/O">Mother(Daughter)</option>
                                            <option value="C/O">Father</option>
                                            <option value="W/O">Husbend</option>
                                        </select>
                                        <input type="text" class="form-control" placeholder="Enter Gurdain Name"
